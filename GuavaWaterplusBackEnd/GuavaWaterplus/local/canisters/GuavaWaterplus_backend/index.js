...
import { idlFactory } from './GuavaWaterplus_backend.did.js';
export { idlFactory } from './GuavaWaterplus_backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.GUAVAWATERPLUS_BACKEND_CANISTER_ID;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./GuavaWaterplus_backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the GuavaWaterplus_backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./GuavaWaterplus_backend.did.js")._SERVICE>}
 */
export const GuavaWaterplus_backend = createActor(canisterId);
